...
//        logoMap.put("Gold", new ImageView(new Image("/resources/gold_logo.gif")));
//        logoMap.put("Iron", new ImageView(new Image("/resources/iron_logo.gif")));
//        logoMap.put("Wood", new ImageView(new Image("/resources/wood_logo.gif")));
//        logoMap.put("Food", new ImageView(new Image("/resources/food_logo.gif")));
//        logoMap.put("Water", new ImageView(new Image("/resources/water_logo.gif")));
